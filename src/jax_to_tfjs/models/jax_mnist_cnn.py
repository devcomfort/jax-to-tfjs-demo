"""
JAX MNIST CNN 모델 실행 모듈

이 모듈은 JAX 모델을 사용하여 MNIST 데이터셋을 학습하는 실행 스크립트를 제공합니다.
...
from .jax.cnn_model import CNNModel
from .jax.utils import load_checkpoint
